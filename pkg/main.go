...
import (
	...
	pkg "git.solsynth.dev/hypernet/wallet/pkg/internal"
	"git.solsynth.dev/hypernet/wallet/pkg/internal/gap"
	"github.com/fatih/color"

	"git.solsynth.dev/hypernet/wallet/pkg/internal/cache"
	"git.solsynth.dev/hypernet/wallet/pkg/internal/database"
	"git.solsynth.dev/hypernet/wallet/pkg/internal/grpc"

	"git.solsynth.dev/hypernet/wallet/pkg/internal/server"
